...
| Deploy landing page + CRX | push to `main` — GitHub Actions builds `landing/dist`, packs `extension.crx` using Chrome's own packer, publishes it as a GitHub Release asset (`latest`), and deploys to GitHub Pages |
